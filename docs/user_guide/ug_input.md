...
!!! Warning
    ...
    ground altitude is optional because it is autofilled if not provided. The autofill rule is the following: set ground altitude to conductor attachment altitude - options_paramater.  
