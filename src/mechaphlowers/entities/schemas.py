...
class CableArrayInput(pa.DataFrameModel):
    ...
    rts_cable: Optional[pdt.Series[pd.Int64Dtype()]] = pa.Field(
        nullable=True, coerce=True
    )
    rts_layer_1: Optional[pdt.Series[pd.Int64Dtype()]] = pa.Field(
        nullable=True, coerce=True
    )
    rts_layer_2: Optional[pdt.Series[pd.Int64Dtype()]] = pa.Field(
        nullable=True, coerce=True
    )
    rts_layer_3: Optional[pdt.Series[pd.Int64Dtype()]] = pa.Field(
        nullable=True, coerce=True
    )
    rts_layer_4: Optional[pdt.Series[pd.Int64Dtype()]] = pa.Field(
        nullable=True, coerce=True
    )
    rts_layer_5: Optional[pdt.Series[pd.Int64Dtype()]] = pa.Field(
        nullable=True, coerce=True
    )
    rts_layer_6: Optional[pdt.Series[pd.Int64Dtype()]] = pa.Field(
        nullable=True, coerce=True
    )
    rts_layer_7: Optional[pdt.Series[pd.Int64Dtype()]] = pa.Field(
        nullable=True, coerce=True
    )
    rts_layer_8: Optional[pdt.Series[pd.Int64Dtype()]] = pa.Field(
        nullable=True, coerce=True
    )
